...
#define TFT_BACKLIGHT 7  // Display backlight pin
    ...
    defined(ADAFRUIT_HALLOWING_M4_EXPRESS)
...
void setup(void) {
  ...
  // override it here
  // Note that speed allowable depends on chip and quality of wiring, if you go
  // too fast, you may end up with a black screen some times, or all the time.
