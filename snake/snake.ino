...
unsigned long scaleToSpeed(int unscaled, int maxAllowed, int minAllowed, int unscaledMax, int unscaledMin);
...
void setup(void) {
    ...
    tft.getTextBounds(MESSAGE, (int16_t) 0, (int16_t) 0, &x1, &y1, &textWidth, &textHeight);
    Serial.print(F("x1 "));
    Serial.println(x1);
    Serial.print(F("y1 "));
    Serial.println(y1);
